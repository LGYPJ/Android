...
import com.softsquared.template.Garamgaebi.databinding.ItemMyprofileSnsBinding

class SnsMYRVAdapter(private val dataList: ArrayList<SnsRVItemData>): RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    //viewHolder 객체
    inner class DataViewHolder(private val viewBinding: ItemMyprofileSnsBinding): RecyclerView.ViewHolder(viewBinding.root){
        ...
        fun bind(data: SnsRVItemData) {
            ...
            viewBinding.activityMyprofileSnsListItemTvName.setText(data.snsAddress)
        }
    }
...
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val Binding = ItemMyprofileSnsBinding.inflate(
