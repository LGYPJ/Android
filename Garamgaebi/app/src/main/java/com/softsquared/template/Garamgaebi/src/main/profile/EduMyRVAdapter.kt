...
import com.softsquared.template.Garamgaebi.databinding.ItemMyprofileEduBinding

class EduMyRVAdapter(private val dataList: ArrayList<EduRVItemData>): RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    //viewHolder 객체
    inner class DataViewHolder(private val viewBinding: ItemMyprofileEduBinding): RecyclerView.ViewHolder(viewBinding.root){
...
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val Binding = ItemMyprofileEduBinding.inflate(
