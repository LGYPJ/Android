...
class GatheringSeminarThisMonthRVAdapter(private val dataList: ArrayList<GatheringSeminarItemData>): RecyclerView.Adapter<GatheringSeminarThisMonthRVAdapter.ViewHolder>() {
    private lateinit var itemClickListener: GatheringSeminarThisMonthRVAdapter.OnItemClickListener
