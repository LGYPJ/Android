...
class NetworkingGamePlaceActivity : BaseActivity<ActivityNetworkingGamePlaceBinding>(ActivityNetworkingGamePlaceBinding::inflate) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        shadow_fade_in = AnimationUtils.loadAnimation(this, R.anim.activity_game_card_shadow_fade_in)
        ...
        binding.activityGameCardStartBtn.setOnClickListener {
            ...
            thread(start=true){
                ...
                runOnUiThread {
                    ...
                    fadeInAnim = AnimationUtils.loadAnimation(this, R.anim.activity_game_fade_in)
    ...
    override fun onStart() {
        super.onStart()
        binding.activityGameCardBackImg.visibility = INVISIBLE
    }
