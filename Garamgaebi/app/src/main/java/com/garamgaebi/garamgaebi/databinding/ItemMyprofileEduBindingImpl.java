...
public class ItemMyprofileEduBindingImpl extends ItemMyprofileEduBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.activity_myprofile_edu_list_item_iv_edit, 6);
    }
    // views
    @NonNull
    ...
    public ItemMyprofileEduBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private ItemMyprofileEduBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
