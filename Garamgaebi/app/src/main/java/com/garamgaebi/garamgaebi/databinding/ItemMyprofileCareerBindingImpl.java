...
public class ItemMyprofileCareerBindingImpl extends ItemMyprofileCareerBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.activity_myprofile_career_list_item_iv_edit, 6);
    }
    // views
    @NonNull
    ...
    public ItemMyprofileCareerBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private ItemMyprofileCareerBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
