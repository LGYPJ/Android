...
/**
 <NetworkingChargedApplyFragment>
 화면 기능 : 네트웨킹 일시, 장소, 참가비, 신청마감 상세정보 보여줌 & 이름, 닉네임, 전화번호 기입하여 네트워킹 신청하는 기능

 네트워킹 상세 정보 -> 데이터바인딩 이용
 ...
 신청하기 버튼 클릭 -> NetworkingFragment 화면으로
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        keyboardVisibilityUtils = KeyboardVisibilityUtils(requireActivity().window,
            onShowKeyboard = { keyboardHeight ->
                ...
                binding.activityNetworkChargedApplyBtn.visibility = View.GONE
                binding.activityNetworkChargedApplyBtn.visibility = View.GONE
