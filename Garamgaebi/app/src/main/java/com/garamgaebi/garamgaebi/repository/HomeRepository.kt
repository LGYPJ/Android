...
class HomeRepository {
    ...
    suspend fun postAutoLogin(request : AutoLoginRequest) = homeClient.postAutoLogin(request)
    fun postLoginForRefresh(request: AutoLoginRequest) = homeClient.postLoginForRefresh(request)
